...
#' @export
M2pow2two <- function(m2, m4, n_x, n_y) {
...
#' @export
M5two <- function(m2, m3, m5, n_x, n_y) {
...
#' @export
M2M3two <- function(m2, m3, m5, n_x, n_y) {
